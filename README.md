...
Данная домашняя работа направлена на тестирование различных кейсов при работе с программой.

## Установка

1. **Клонируйте репозиторий:**
```
git clone https://github.com/PyTopG/TopG-homeworks-repo.git
```
...
```
2. **Тестирование проекта осуществляется командой:**

`pytest`

3. **Введите команду для проверки покрытия тестами:**
```
...
# Модуль Логирования
Этот модуль предоставляет декоратор для логирования выполнения функций.

## Декоратор
### @log()
Декоратор для логирования выполнения функций. Он записывает в лог информацию о том, успешно ли завершилась функция, или произошла ошибка.
...
Просто добавьте @log() перед определением функции, которую хотите логировать.
